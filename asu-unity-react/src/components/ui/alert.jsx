  ...
  "relative w-full rounded-lg border border-border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        warning: "border-yellow-400/50 bg-yellow-50 text-yellow-800 [&>svg]:text-yellow-600",
        success: "border-green-400/50 bg-green-50 text-green-800 [&>svg]:text-green-600",
      },
    },
